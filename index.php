...
<html lang="en">
  <head>
    ...
    <title> E-Catalogue Perpustakaan SMP Fatahillah Ciledug </title>
...
<link href="assets/css/bootstrap.min.css" rel="stylesheet">
    ...
    <style>
      body{
        ...
        background-size: 100%;
        background-image: url('assets/img/smpciledug.jpeg')
      }
  ...
  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#">SMP Fatahillah Ciledug</a>
        ...
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link active" href="#">
              ...
              E-Katalog Perpustakaan<span class="sr-only">(current)</span>
            </a>
          </li>
          <li class="nav-item">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          ...
          <a href="profile.php"><img src="assets/img/smpfatahillah.png" style="width: 50px; border-radius: 50%;"></a>
        </div>
      </div>



      <h2 align="center">E-Catalogue Perpustakaan SMP Fatahillah Ciledug</h2>
      <br>
